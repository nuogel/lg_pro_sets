...
def main():
    ...
    def _parse_gtfiles_xml():
        ...
        gt_counter_per_class = {}
        counter_images_per_class = {}
        for i, txt_file in enumerate(ground_truth_files_list):
            print(i, len(ground_truth_files_list), txt_file)
            ...
            for obj in root.findall('object'):
                try:
                    ...
                    left, top, right, bottom = bbox.find('xmin').text, bbox.find('ymin').text, \
    ...
    gt_counter_per_class, counter_images_per_class, ground_truth_files_list = _parse_gtfiles_xml()
