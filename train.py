...
def _parse_arguments():
    ...
    parser.add_argument('--lr_continue', '--l_c', default=0, type=float, help='learning rate')
    ...
    parser.add_argument('--pre_trained', '--p_t', default=0, type=int, help='Epoch of continue training')
