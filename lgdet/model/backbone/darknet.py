...
def darknet_tiny2(pretrained=False, hr=False, **kwargs):
...
def darknet_tiny1(pretrained=False):
    model = DarkNet_Light()
    if pretrained:
        weight_path = 'saved/checkpoint/darknet_light_90_58.99.pth'
        model.load_state_dict(torch.load(weight_path, map_location='cuda'), strict=False)
    return model


# if __name__ == '__main__':
#     model_pretrained = darknet_tiny1(pretrained=True)
#     model_scratch = darknet_tiny1()
#
