...
class Decoder(nn.Module):
    def __init__(self, n_mels, n_frames_per_step,
                 ...
                 decoder_n_lstms, p_attention_dropout, cfg):
    ...
    def decode(self, prenet_output):
        ...
        # [B, 1, decoder_dim]
        x = F.dropout(self.h0, self.p_attention_dropout, self.training)

        x = torch.cat((x, self.attention_context), dim=-1)
        self.h1, self.c1 = self.lstm1(x, (self.h1, self.c1))
        # [B, 1, decoder_dim]
        self.query = F.dropout(self.h1, self.p_attention_dropout, self.training)
...
class TACOTRON2(nn.Module):
    def __init__(self, cfg):
        ...
        p_attention_dropout = cfg.TRAIN.p_attention_dropout
        # postnet
