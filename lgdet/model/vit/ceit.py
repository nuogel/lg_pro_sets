...
from lgdet.model.vit.common_module import Residual, Attention, PreNorm, LeFF, FeedForward, LCAttention
...
class CeiT(nn.Module):
    def __init__(self, image_size, patch_size, num_classes, dim=192, depth=12, heads=3, pool='cls', in_channels=3, out_channels=32, dim_head=64, dropout=0.,
                 emb_dropout=0., conv_kernel=7, stride=2, depth_kernel=3, pool_kernel=3, scale_dim=4, with_lca=False, lca_heads=4, lca_dim_head=48,
                 lca_mlp_dim=384):
        super().__init__()
