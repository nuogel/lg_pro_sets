...
class TACOTRON(nn.Module):
    def __init__(self, cfg):
        ...
        label_dict = torch.load('DataLoader/others/bb_dict.pth')
        n_vocab = len(label_dict)
        embedding_dim = 256
        mel_dim = cfg.TRAIN.num_mels
        linear_dim = cfg.TRAIN.num_freq
        r = 5
        padding_idx = None
        use_memory_mask = cfg.TRAIN.use_memory_mask
    ...
    def forward(self, **args):
        inputs, input_lengths, targets, y_batch = args['input_data']
