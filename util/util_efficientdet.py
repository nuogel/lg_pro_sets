...
class DecodeBBox(nn.Module):
    ...
    def forward(self, predicts, anchors_xywh):
        a_width = anchors_xywh[..., 2]
        a_height = anchors_xywh[..., 3]
        ctr_x = anchors_xywh[..., 0]
        ctr_y = anchors_xywh[..., 1]
        ...
        pred_boxes_xyxy = torch.stack([pred_boxes_x1, pred_boxes_y1, pred_boxes_x2, pred_boxes_y2], dim=-1)
...
class ClipBoxes(nn.Module):
    ...
    def forward(self, boxes, img, cfg):
